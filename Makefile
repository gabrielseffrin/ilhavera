.PHONY: up down sh install lint typecheck test test-watch coverage heavy play demo dev web build clean logs
...
## Cliente web em modo watch, na porta 5173 do host
web:
